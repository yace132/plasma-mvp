...
contract RootChain {
    ...
    uint256 constant internal MIN_EXIT_PERIOD = 1 weeks;
    uint256 constant internal CHILD_BLOCK_INTERVAL = 1000;
        ...
        onlyOperator
    {
        ...
        emit BlockSubmitted(currentChildBlock, _blockRoot);
    }
        ...
        public
    {
        ...
        while (exitQueue.currentSize() > 0) {
            // Pull the next exit.
            (uniqueId, exitableTimestamp) = _getNextExit();
        ...
        internal
    {
        ...
        // Delete everything but the timestamp to block additional exits.
        delete _inFlightExit.exitMap;
